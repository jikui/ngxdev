...
typedef enum {
    NGX_STREAM_ALG_FTP = 1, 
} ngx_stream_ALG_FLAGS;
...
typedef struct ngx_stream_alg_ctx_s  ngx_stream_alg_ctx_t;


typedef ngx_int_t (*ngx_stream_alg_content_handler_pt)
        (ngx_stream_session_t *s, ngx_stream_alg_ctx_t *ctx);


struct ngx_stream_alg_ctx_s {
    ...
    ngx_stream_alg_filter_handler_pt        input_filter;
...
static ngx_conf_enum_t  ngx_stream_alg_client_error_log_levels[] = {
...
static ngx_conf_enum_t  ngx_stream_alg_lingering_close[] = {
